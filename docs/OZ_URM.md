...
For DAOs using OpenZeppelin Governor systems, the URM integrates directly with the existing multi-executor timelock infrastructure. This implementation is simpler than the Compound version since OpenZeppelin Governor already supports multiple executors.
