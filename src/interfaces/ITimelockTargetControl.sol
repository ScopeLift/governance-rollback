...
/// @title ITimelockTargetControl
/// @author [ScopeLift](https://scopelift.co)
/// @notice Minimal interface for interacting with an OZ timelock-compatible target used by Rollback Manager.
...
interface ITimelockTargetControl {
