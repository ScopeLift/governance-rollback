...
contract RollbackManagerTimelockCompoundDeployInput {
  ...
  // Deployed RollbackManagerTimelockCompound contract
  address public ROLLBACK_MANAGER_TIMELOCK_COMPOUND = address(0);
}
