...
import {RollbackManagerUnitTestBase} from "test/helpers/RollbackManagerUnitTestBase.sol";
...
contract Constructor is RollbackManagerTimelockCompoundTest {
  function testFuzz_SetsInitialParameters(
    ...
    RollbackManagerTimelockCompound _rollbackManager = new RollbackManagerTimelockCompound(
      _targetTimelock, _admin, _guardian, _rollbackQueueableDuration, _minRollbackQueueableDuration
    );
  ...
  function testFuzz_EmitsRollbackQueueableDurationSet(
    ...
    new RollbackManagerTimelockCompound(
      _targetTimelock, _admin, _guardian, _rollbackQueueableDuration, _minRollbackQueueableDuration
    );
  }
  ...
  function testFuzz_RevertIf_TargetTimelockIsZeroAddress(
    ...
    new RollbackManagerTimelockCompound(
      address(0), _admin, _guardian, _rollbackQueueableDuration, _minRollbackQueueableDuration
    );
  }
  ...
  function testFuzz_RevertIf_MinRollbackQueueableDurationIsZero(
    ...
    vm.expectRevert(RollbackManager.RollbackManager__InvalidRollbackQueueableDuration.selector);
    new RollbackManagerTimelockCompound(_targetTimelock, _admin, _guardian, _rollbackQueueableDuration, 0);
  }
}

contract GetRollback is RollbackManagerTimelockCompoundTest {
