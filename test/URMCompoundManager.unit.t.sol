...
contract URMCompoundManagerTest is URMUnitTestBase {
  ...
  function _deployURM(
    ...
    return new URMCompoundManager(
      address(targetTimelock), _admin, _guardian, _rollbackQueueableDuration, _minRollbackQueueableDuration
    );
  }
}
